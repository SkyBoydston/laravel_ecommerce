    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Business contact panel</div>
                <div class="panel-body">

					{!! Form::model($business_contact, ['method' => 'PATCH', 'action' => ['BusinessContactController@update', $business_contact_id], 'class' => 'form-horizontal']) !!}
