    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Edit quote details</div>
                <div class="panel-body">

					{!! Form::model($quote, ['method' => 'PATCH', 'action' => ['QuoteController@update', $quote->id], 'class' => 'form-horizontal']) !!}
					    ...
					    <div class="form-group{{ $errors->has('notes') ? ' has-error' : '' }}">
						    ...
						    <div class="col-md-6">
							    {!! Form::textarea('notes', $quote->notes, array('class' => 'form-control')) !!}
